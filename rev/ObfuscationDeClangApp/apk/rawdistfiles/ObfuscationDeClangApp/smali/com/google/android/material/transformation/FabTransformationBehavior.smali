...
.method public u(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    :goto_0
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string v12, "elevation"

    invoke-virtual {v11, v12}, La1/g;->d(Ljava/lang/String;)La1/h;

    move-result-object v11

    invoke-virtual {v11, v7}, La1/h;->a(Landroid/animation/Animator;)V
    ...
    .line 5
    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ls/d;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Ls/d;)F

    move-result v11

    iget-object v12, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ls/d;

    invoke-virtual {v0, v1, v2, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Ls/d;)F
    ...
    .line 6
    invoke-virtual {v0, v4, v14, v11, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;La1/h;FF)F

    move-result v11

    invoke-virtual {v0, v4, v13, v12, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;La1/h;FF)F
    ...
    :goto_1
    invoke-virtual {v14, v6}, La1/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v8}, La1/h;->a(Landroid/animation/Animator;)V
    ...
    .line 9
    iget-object v8, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ls/d;

    invoke-virtual {v0, v1, v2, v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Ls/d;)F

    move-result v8

    iget-object v11, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ls/d;

    invoke-virtual {v0, v1, v2, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Ls/d;)F
    ...
    invoke-virtual {v12, v11}, La1/h;->a(Landroid/animation/Animator;)V
    ...
    :cond_9
    sget-object v13, La1/d;->a:Landroid/util/Property;
    ...
    :cond_a
    sget-object v14, La1/d;->a:Landroid/util/Property;
    ...
    iget-object v14, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string v15, "iconFade"

    invoke-virtual {v14, v15}, La1/g;->d(Ljava/lang/String;)La1/h;

    move-result-object v14

    invoke-virtual {v14, v13}, La1/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v5, v13}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v13, Lcom/google/android/material/transformation/b;

    invoke-direct {v13, v0, v11, v12}, Lcom/google/android/material/transformation/b;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lj1/d;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ls/d;
    ...
    invoke-virtual {v0, v1, v2, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior;->w(Landroid/view/View;Landroid/view/View;Ls/d;)F
    ...
    .line 15
    iget-object v10, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Ls/d;
    ...
    invoke-virtual {v0, v1, v2, v10}, Lcom/google/android/material/transformation/FabTransformationBehavior;->x(Landroid/view/View;Landroid/view/View;Ls/d;)F
    ...
    iget-object v13, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string v14, "expansion"

    invoke-virtual {v13, v14}, La1/g;->d(Ljava/lang/String;)La1/h;
    ...
    new-instance v14, Lj1/d$e;

    invoke-direct {v14, v9, v8, v10}, Lj1/d$e;-><init>(FFF)V

    invoke-interface {v12, v14}, Lj1/d;->setRevealInfo(Lj1/d$e;)V

    :cond_d
    if-eqz p4, :cond_e

    invoke-interface {v12}, Lj1/d;->getRevealInfo()Lj1/d$e;

    move-result-object v10

    iget v10, v10, Lj1/d$e;->c:F

    :cond_e
    const/4 v14, 0x0

    .line 20
    invoke-static {v9, v8, v14, v14}, Ls/d;->u(FFFF)F

    move-result v15

    invoke-static {v9, v8, v6, v14}, Ls/d;->u(FFFF)F

    move-result v21

    invoke-static {v9, v8, v6, v7}, Ls/d;->u(FFFF)F

    move-result v6

    invoke-static {v9, v8, v14, v7}, Ls/d;->u(FFFF)F
    ...
    .line 21
    :goto_7
    invoke-static {v12, v9, v8, v15}, Lj1/b;->a(Lj1/d;FFF)Landroid/animation/Animator;

    move-result-object v6

    new-instance v7, Lcom/google/android/material/transformation/c;

    invoke-direct {v7, v0, v12}, Lcom/google/android/material/transformation/c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lj1/d;)V

    invoke-virtual {v6, v7}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 22
    iget-wide v14, v13, La1/h;->a:J
    ...
    iget v0, v0, Lj1/d$e;->c:F

    invoke-static {v12, v9, v8, v10}, Lj1/b;->a(Lj1/d;FFF)Landroid/animation/Animator;
    ...
    .line 28
    iget-wide v8, v13, La1/h;->b:J

    .line 29
    iget-object v0, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    move-object/from16 v21, v6

    .line 30
    iget-object v6, v0, La1/g;->a:Lm/g;
    ...
    invoke-virtual {v6, v11}, Lm/g;->k(I)Ljava/lang/Object;
    ...
    .line 33
    iget-wide v12, v6, La1/h;->a:J

    move-object/from16 v25, v5

    .line 34
    iget-wide v5, v6, La1/h;->b:J
    ...
    .line 37
    :goto_a
    invoke-virtual {v0, v6}, La1/h;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {v0, v3}, Lj1/a;-><init>(Lj1/d;)V
    ...
    .line 44
    invoke-interface {v0, v4}, Lj1/d;->setCircularRevealScrimColor(I)V

    :cond_19
    sget-object v4, Lj1/d$d;->a:Landroid/util/Property;
    ...
    sget-object v5, Lj1/d$d;->a:Landroid/util/Property;
    ...
    :goto_d
    sget-object v4, La1/b;->a:La1/b;

    invoke-virtual {v0, v4}, Landroid/animation/ObjectAnimator;->setEvaluator(Landroid/animation/TypeEvaluator;)V

    move-object/from16 v4, v22

    iget-object v5, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string v7, "color"

    invoke-virtual {v5, v7}, La1/g;->d(Ljava/lang/String;)La1/h;

    move-result-object v5

    invoke-virtual {v5, v0}, La1/h;->a(Landroid/animation/Animator;)V
    ...
    :cond_1c
    instance-of v0, v2, Lb2/b;

    if-nez v0, :cond_1e

    instance-of v0, v2, Lb2/a;
    ...
    .line 47
    sget-object v7, La1/c;->a:Landroid/util/Property;
    ...
    :goto_13
    iget-object v4, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string v7, "contentFade"

    invoke-virtual {v4, v7}, La1/g;->d(Ljava/lang/String;)La1/h;

    move-result-object v4

    invoke-virtual {v4, v0}, La1/h;->a(Landroid/animation/Animator;)V
    ...
    invoke-static {v0, v1}, Lw1/e;->D(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final v(FFZLcom/google/android/material/transformation/FabTransformationBehavior$b;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, La1/g;->d(Ljava/lang/String;)La1/h;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;
    ...
    :goto_1
    invoke-virtual {p2, p3}, La1/g;->d(Ljava/lang/String;)La1/h;
...
.method public final w(Landroid/view/View;Landroid/view/View;Ls/d;)F
    .locals 3
...
.method public final x(Landroid/view/View;Landroid/view/View;Ls/d;)F
    .locals 3
...
.method public final y(Lcom/google/android/material/transformation/FabTransformationBehavior$b;La1/h;FF)F
    .locals 8

    .line 1
    iget-wide v0, p2, La1/h;->a:J

    .line 2
    iget-wide v2, p2, La1/h;->b:J

    .line 3
    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:La1/g;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, La1/g;->d(Ljava/lang/String;)La1/h;

    move-result-object p1

    .line 4
    iget-wide v4, p1, La1/h;->a:J

    .line 5
    iget-wide v6, p1, La1/h;->b:J
    ...
    .line 6
    invoke-virtual {p2}, La1/h;->b()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, La1/a;->a(FFF)F
