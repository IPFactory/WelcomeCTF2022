...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lb1/c;->c:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lb1/c;->d:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lb1/c;->c:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lb1/c;->d:Landroid/graphics/Rect;
...
.method public i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-virtual {p0, v3}, Lb1/c;->v(Ljava/util/List;)Landroid/view/View;
    ...
    .line 2
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Lg0/a0;

    move-result-object v5

    if-eqz v5, :cond_2

    invoke-virtual {v5}, Lg0/a0;->d()I

    move-result v6

    invoke-virtual {v5}, Lg0/a0;->a()I
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v3}, Lb1/c;->y(Landroid/view/View;)I
    ...
    invoke-virtual/range {v6 .. v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->s(Landroid/view/View;IIII)V
...
.method public t(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v0}, Lb1/c;->v(Ljava/util/List;)Landroid/view/View;
    ...
    iget-object v5, p0, Lb1/c;->c:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object p1, p0, Lb1/c;->d:Landroid/graphics/Rect;
    ...
    .line 4
    invoke-virtual {p0, v0}, Lb1/c;->w(Landroid/view/View;)I
...
.method public final w(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lb1/c;->x(Landroid/view/View;)F
    ...
    invoke-static {p1, v1, v0}, Ls/d;->t(III)I
