...
.method public e(Landroid/util/AttributeSet;I)V
    ...
    .line 2
    invoke-static/range {v1 .. v7}, Lg0/u;->o(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-static {v10, v11, v4}, Landroidx/appcompat/widget/b0;->c(Landroid/content/Context;Landroidx/appcompat/widget/k;I)Landroidx/appcompat/widget/z0;

    move-result-object v4

    iput-object v4, v0, Landroidx/appcompat/widget/b0;->g:Landroidx/appcompat/widget/z0;

    .line 3
    :cond_5
    iget-object v4, v13, Landroidx/appcompat/widget/b1;->b:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v6, v10, v1}, Landroidx/appcompat/widget/b1;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v4, :cond_6

    .line 6
    invoke-virtual {v6, v3}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v5

    if-eqz v5, :cond_6

    invoke-virtual {v6, v3, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z
    ...
    :goto_0
    invoke-virtual {v0, v10, v6}, Landroidx/appcompat/widget/b0;->m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V

    invoke-virtual {v6, v15}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v19

    if-eqz v19, :cond_7

    invoke-virtual {v6, v15}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v6, v7}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v17

    if-eqz v17, :cond_8

    invoke-virtual {v6, v7}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-direct {v7, v10, v1}, Landroidx/appcompat/widget/b1;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v4, :cond_a

    .line 10
    invoke-virtual {v7, v3}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v20

    if-eqz v20, :cond_a

    invoke-virtual {v7, v3, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z
    ...
    :cond_a
    invoke-virtual {v7, v15}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v3

    if-eqz v3, :cond_b

    invoke-virtual {v7, v15}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v13}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v17

    if-eqz v17, :cond_d

    invoke-virtual {v7, v13}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v12}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v13

    if-eqz v13, :cond_e

    invoke-virtual {v7, v12, v14}, Landroidx/appcompat/widget/b1;->f(II)I
    ...
    :cond_e
    invoke-virtual {v0, v10, v7}, Landroidx/appcompat/widget/b0;->m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
    ...
    :cond_14
    :goto_6
    iget-object v15, v0, Landroidx/appcompat/widget/b0;->i:Landroidx/appcompat/widget/e0;

    .line 14
    iget-object v1, v15, Landroidx/appcompat/widget/e0;->j:Landroid/content/Context;

    sget-object v3, Ls/d;->m:[I
    ...
    iget-object v1, v15, Landroidx/appcompat/widget/e0;->i:Landroid/widget/TextView;
    ...
    iput v1, v15, Landroidx/appcompat/widget/e0;->a:I
    ...
    :cond_19
    invoke-virtual {v15, v13}, Landroidx/appcompat/widget/e0;->b([I)[I

    move-result-object v7

    iput-object v7, v15, Landroidx/appcompat/widget/e0;->f:[I

    invoke-virtual {v15}, Landroidx/appcompat/widget/e0;->h()Z
    ...
    invoke-virtual {v15}, Landroidx/appcompat/widget/e0;->i()Z

    move-result v6

    if-eqz v6, :cond_20

    iget v6, v15, Landroidx/appcompat/widget/e0;->a:I

    if-ne v6, v3, :cond_21

    iget-boolean v6, v15, Landroidx/appcompat/widget/e0;->g:Z

    if-nez v6, :cond_1f

    iget-object v6, v15, Landroidx/appcompat/widget/e0;->j:Landroid/content/Context;
    ...
    :cond_1e
    invoke-virtual {v15, v4, v5, v1}, Landroidx/appcompat/widget/e0;->j(FFF)V

    :cond_1f
    invoke-virtual {v15}, Landroidx/appcompat/widget/e0;->g()Z
    ...
    .line 18
    iget v4, v1, Landroidx/appcompat/widget/e0;->a:I
    ...
    .line 23
    iget v4, v4, Landroidx/appcompat/widget/e0;->e:F
    ...
    .line 24
    iget-object v5, v0, Landroidx/appcompat/widget/b0;->i:Landroidx/appcompat/widget/e0;

    .line 25
    iget v5, v5, Landroidx/appcompat/widget/e0;->c:F
...
.method public final m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
    ...
    invoke-virtual {p2, v5, p1, v9}, Landroidx/appcompat/widget/b1;->i(IILy/f$c;)Landroid/graphics/Typeface;
