...
# direct methods
.method public constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILw1/i;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lw1/i;
...
.method public static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v2, v3}, Ls/d;->k(ZLjava/lang/Object;)V

    sget-object v2, Ls/d;->A0:[I
    ...
    invoke-static {p0, p1, v0}, Lt1/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v3, v1}, Lw1/a;-><init>(F)V

    invoke-static {p0, v0, v2, v3}, Lw1/i;->a(Landroid/content/Context;IILw1/c;)Lw1/i$b;

    move-result-object p0

    .line 2
    invoke-virtual {p0}, Lw1/i$b;->a()Lw1/i;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILw1/i;Landroid/graphics/Rect;)V
...
.method public b(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lw1/i;

    invoke-virtual {v0, v2}, Lw1/f;->setShapeAppearanceModel(Lw1/i;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lw1/i;

    invoke-virtual {v1, v2}, Lw1/f;->setShapeAppearanceModel(Lw1/i;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lw1/f;->q(Landroid/content/res/ColorStateList;)V
