...
.method public final run()V
    ...
    .line 6
    sget-object v5, Lz/e;->a:Lz/k;

    const/4 v6, 0x0

    invoke-virtual {v5, v3, v6, v2, v4}, Lz/k;->b(Landroid/content/Context;Landroid/os/CancellationSignal;[Ld0/l;I)Landroid/graphics/Typeface;
    ...
    .line 9
    invoke-static {v3, v6, v1}, Lz/l;->d(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1}, Lw1/e;->E(Ljava/nio/ByteBuffer;)Ln0/b;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Landroidx/emoji2/text/l;-><init>(Landroid/graphics/Typeface;Ln0/b;)V
    :try_end_5
    ...
    invoke-virtual {v2, v3}, Landroidx/emoji2/text/d$h;->b(Landroidx/emoji2/text/l;)V
