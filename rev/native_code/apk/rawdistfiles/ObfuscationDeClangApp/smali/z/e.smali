...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lz/e;->b:Lm/e;

    return-void
.end method

.method public static a(Landroid/content/Context;Ly/d$a;Landroid/content/res/Resources;IILy/f$c;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 6

    instance-of v0, p1, Ly/d$d;

    const/4 v1, -0x3

    if-eqz v0, :cond_d

    check-cast p1, Ly/d$d;

    .line 1
    iget-object v0, p1, Ly/d$d;->d:Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {p5, v0, p6}, Ly/f$c;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    .line 6
    :goto_3
    invoke-static {p6}, Ly/f$c;->c(Landroid/os/Handler;)Landroid/os/Handler;

    move-result-object p6

    new-instance v4, Lz/e$a;

    invoke-direct {v4, p5}, Lz/e$a;-><init>(Ly/f$c;)V

    .line 7
    iget-object p1, p1, Ly/d$d;->a:Ld0/e;

    .line 8
    new-instance p5, Ld0/c;

    invoke-direct {p5, v4, p6}, Ld0/c;-><init>(Lw1/e;Landroid/os/Handler;)V

    if-eqz v3, :cond_9

    sget-object v3, Ld0/j;->a:Lm/e;
    ...
    invoke-direct {p0, p5, v4, v5}, Ld0/a;-><init>(Ld0/c;Lw1/e;Landroid/graphics/Typeface;)V
    ...
    .line 18
    :catch_3
    iget-object p0, p5, Ld0/c;->a:Lw1/e;

    iget-object p1, p5, Ld0/c;->b:Landroid/os/Handler;

    new-instance p6, Ld0/b;

    invoke-direct {p6, p5, p0, v1}, Ld0/b;-><init>(Ld0/c;Lw1/e;I)V
    ...
    .line 23
    sget-object v0, Ld0/j;->a:Lm/e;

    invoke-virtual {v0, p7}, Lm/e;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p5, v4, v0}, Ld0/a;-><init>(Ld0/c;Lw1/e;Landroid/graphics/Typeface;)V
    ...
    :try_start_3
    sget-object p5, Ld0/j;->d:Lm/g;

    .line 26
    invoke-virtual {p5, p7, v2}, Lm/g;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p5, p7, v1}, Lm/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 29
    :goto_4
    new-instance p7, Ld0/n;

    invoke-direct {p7, p6, p5, p1}, Ld0/n;-><init>(Landroid/os/Handler;Ljava/util/concurrent/Callable;Lf0/a;)V
    ...
    check-cast p1, Ly/d$b;

    invoke-virtual {p7, p0, p1, p2, p4}, Lz/k;->a(Landroid/content/Context;Ly/d$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p5, v2, p6}, Ly/f$c;->b(Landroid/graphics/Typeface;Landroid/os/Handler;)V

    goto :goto_5

    :cond_e
    invoke-virtual {p5, v1, p6}, Ly/f$c;->a(ILandroid/os/Handler;)V

    :cond_f
    :goto_5
    if-eqz v2, :cond_10

    sget-object p0, Lz/e;->b:Lm/e;
